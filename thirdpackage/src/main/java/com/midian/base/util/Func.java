...
public class Func {
	...
	public final static Pattern mobiler = Pattern.compile("^(((17[0-9]))|(13[0-9])|(15[^4,\\D])|(18[0-9]))\\d{8}$");
	...
	public static String bankCardFormat(String cardNumber){
		...
		for (int i = 0; i < length; i+=4) {
			if((i+4)<cardNumber.length()){
				...
				result.append(cardNumber.substring(i));
			}
		}
