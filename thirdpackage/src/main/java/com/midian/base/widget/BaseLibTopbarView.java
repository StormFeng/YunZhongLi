...
//        setBackgroundResource(android.R.color.transparent);
	...
	public BaseLibTopbarView setTitle(String title) {
		...
		title_tv.setTextColor(Color.parseColor("#303030"));
		return this;
	}
	...
	public BaseLibTopbarView setLeftText(String text, OnClickListener onclickListener) {
		...
		left_tv.setTextColor(Color.parseColor("#303030"));
	...
	public BaseLibTopbarView setRightText(String text, OnClickListener onclickListener) {
		...
		right_tv.setTextColor(Color.parseColor("#303030"));
		if (onclickListener != null)
	...
	public BaseLibTopbarView setMode(int mode) {
		...
		if (mode == MODE_1) {
			...
			title_tv.setTextColor(getResources().getColor(R.color.text_bg33));
			left_tv.setTextColor(getResources().getColor(R.color.text_bg33));
			right_tv.setTextColor(getResources().getColor(R.color.text_bg33));
