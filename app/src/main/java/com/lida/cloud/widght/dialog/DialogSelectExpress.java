...
public class DialogSelectExpress extends Dialog {
    ...
    private List<ExpressBean.DataBean> data;
    private onItemClickListener listener;

    public DialogSelectExpress(Context context, TextView textView, List<ExpressBean.DataBean> data) {
    ...
    public DialogSelectExpress(Context context, int themeResId) {
        super(context, R.style.right_dialog);
        init(context);
    }
    ...
    private void init(Context context) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                textView.setTag(data.get(position).getCode());
                if(listener!=null){
