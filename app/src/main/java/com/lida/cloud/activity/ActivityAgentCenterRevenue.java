...
import com.lida.cloud.bean.ComparatorRevenue;
...
public class ActivityAgentCenterRevenue extends BaseActivity {
    ...
    private List<ActivityAgentCenterRevenueBean.DataBean.ListBean> data = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_agentcenter_revenue);
        ButterKnife.bind(this);
        topbar.setTitle("收入");
        topbar.setLeftImageButton(R.drawable.icon_back, UIHelper.finish(_activity));
        AppUtil.getApiClient(ac).agentincome("","10000",callback);
    }
    ...
    BaseApiCallback callback = new BaseApiCallback(){
        ...
        public void onApiSuccess(NetResult res, String tag) {
            ...
            if(res.isOK()){
                ...
                ActivityAgentCenterRevenueBean bean = (ActivityAgentCenterRevenueBean) res;
     ...
     * 初始化数据，排序
     */
    private void initData(ActivityAgentCenterRevenueBean bean) {
        ...
        ComparatorRevenue comparatorCar = new ComparatorRevenue();
