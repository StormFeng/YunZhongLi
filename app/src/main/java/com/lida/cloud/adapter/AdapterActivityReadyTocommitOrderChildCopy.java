...
public class AdapterActivityReadyTocommitOrderChildCopy extends BaseAdapter {

    private List<ActivityReadyToCommitOrderBeanCopy.DataBean.ListBean> data;
    private Context context;
    private AppContext ac;

    public AdapterActivityReadyTocommitOrderChildCopy(Context context, List<ActivityReadyToCommitOrderBeanCopy.DataBean.ListBean> data) {
        this.data = data;
