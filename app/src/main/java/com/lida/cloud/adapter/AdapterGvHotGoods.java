...
public class AdapterGvHotGoods extends BaseAdapter {

    private Context context;
    private List<IndexBean.DataBean.HotBean> goodsData = new ArrayList<>();
    private AppContext ac;

    public AdapterGvHotGoods(Context context, List<IndexBean.DataBean.HotBean> goodsData) {
